...
######################################
# CONFIGURE Prosody for XMPP
######################################
mv /etc/prosody/prosody.cfg.lua /etc/prosody/prosody.cfg.lua.bak
cp /tmp/packer/prosody.cfg.lua /etc/prosody/prosody.cfg.lua
echo -e "127.0.0.1 ztps im.ztps-test.com" >> /etc/hosts
prosodyctl start
systemctl enable prosody
prosodyctl register cvx im.ztps-test.com eosplus
prosodyctl register ztpsadmin im.ztps-test.com eosplus
prosodyctl register bootstrap im.ztps-test.com eosplus
prosodyctl register veos-dc1-pod1-tor1 im.ztps-test.com eosplus
prosodyctl register veos-dc1-pod1-tor2 im.ztps-test.com eosplus
prosodyctl register veos-dc1-pod1-tor3 im.ztps-test.com eosplus
prosodyctl register veos-dc1-pod1-tor4 im.ztps-test.com eosplus
prosodyctl register veos-dc1-pod1-tor5 im.ztps-test.com eosplus
prosodyctl register veos-dc1-pod1-tor6 im.ztps-test.com eosplus
prosodyctl register veos-dc1-pod1-spine1 im.ztps-test.com eosplus
prosodyctl register veos-dc1-pod1-spine2 im.ztps-test.com eosplus
prosodyctl register veos-dc1-pod1-spine3 im.ztps-test.com eosplus
prosodyctl register veos-dc1-pod1-spine4 im.ztps-test.com eosplus
prosodyctl restart
sleep 6
prosodyctl status
